function SA = surface_area_from_mesh(mesh, centerline)
...
% for each circular truncated cone, the lateral surface area is
...
function y = cirTrunConArea(r1, r2, h)
    y = pi * (r1 + r2) * sqrt((r1 - r2) ^ 2 + h ^ 2);
end